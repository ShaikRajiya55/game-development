export class Tilemap {
  ...
  constructor(w: number, h: number, tileSize: number = 32) {
    this.width = w;
    this.height = h;
    this.tileSize = tileSize;
    this.data = Array.from({ length: h }, () => Array(w).fill(0));
  }
