...
export class SpriteComponent implements Component {
  ...
  constructor(color: string = '#ffffff', width: number = 32, height: number = 32) {
    this.color = color;
    this.width = width;
    this.height = height;
  }
