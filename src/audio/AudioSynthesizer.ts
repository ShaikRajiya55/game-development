export class AudioSynthesizer {
  ...
  public playTone(freq: number, duration: number, type: OscillatorType = 'square'): void {
    if (!this.ctx) return;
