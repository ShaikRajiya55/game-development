...
export class Engine {
  ...
  constructor(canvasId: string) {
    this.canvas = (document.getElementById(canvasId) as HTMLCanvasElement) || document.createElement('canvas');
  ...
  public update(dt: number): void { if (this.onUpdate) this.onUpdate(dt); }
